...
public class OffsetIT extends ESIntegTestCase {
    ...
    private ZonedDateTime date(int hourOfDay, int minuteOfHour) {
        return ZonedDateTime.of(2018, 2, 12, hourOfDay, minuteOfHour, 0, 0, ZoneOffset.UTC);
    }
    ...
    private IndexRequestBuilder indexDoc(int startHourOfDay, int startMinuteOfHour, int endHourOfDay, int endMinuteOfHour, int value) throws Exception {
        final ZonedDateTime start = date(startHourOfDay, startMinuteOfHour);
        final ZonedDateTime end = date(endHourOfDay, endMinuteOfHour);
    ...
    public void testOffsetCalculation() {
        ZonedDateTime start = ZonedDateTime.of(2018, 2, 12, 11, 10, 0, 0, ZoneOffset.UTC);
        ZonedDateTime end = ZonedDateTime.of(2018, 2, 12, 11, 40, 0, 0, ZoneOffset.UTC);
        ...
        try {
            ...
            if (response != null) {
                response.decRef(); // Properly release the resources
            }
        }
    }
