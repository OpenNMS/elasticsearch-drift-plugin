...
public class SamplingIT extends ESIntegTestCase {
    ...
    private IndexRequestBuilder indexDoc(int startMonth, int startDay, int endMonth, int endDay, int value, double interval) throws Exception {
        ...
        XContentBuilder source = jsonBuilder()
                ...
                .field("value", value)
                .field("constant", 1)
                .field("start", start.toInstant().toEpochMilli())
                .field("end", end.toInstant().toEpochMilli())
    ...
    public void testAggregateWithInterval() {
        ZonedDateTime startDate = ZonedDateTime.of(2012, 1, 1, 0, 0, 0, 0, ZoneOffset.UTC);
        ZonedDateTime endDate = ZonedDateTime.of(2012, 1, 31, 0, 0, 0, 0, ZoneOffset.UTC);
        ...
        SearchResponse response = client().prepareSearch("idx")
                ...
                .addAggregation(new ProportionalSumAggregationBuilder("histo")
                        ...
                        .start(ZonedDateTime.of(2012, 1, 1, 0, 0, 0, 0, ZoneOffset.UTC).toInstant().toEpochMilli())
                        .end(ZonedDateTime.of(2012, 1, 31, 0, 0, 30, 1000, ZoneOffset.UTC).toInstant().toEpochMilli())
        ...
        assertThat(buckets.get(0).getKey(), equalTo(startDate));
    ...
    public void testAggregateWithoutInterval() {
        ...
        System.out.println(" here is the value "+ buckets.get(0).getValue());
