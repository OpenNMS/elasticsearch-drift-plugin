 ...
 * aggregation supplier in the {@link #innerBuild(AggregationContext, ValuesSourceConfig, AggregatorFactory, AggregatorFactories.Builder)}
 * method.
 */
public class FlowHistogramAggregationBuilder extends ValuesSourceAggregationBuilder<FlowHistogramAggregationBuilder> {
    ...
    protected ValuesSourceAggregatorFactory innerBuild(AggregationContext context,
        ...
        HistogramAggregatorSupplier aggregatorSupplier = FlowHistogramAggregator::new;
